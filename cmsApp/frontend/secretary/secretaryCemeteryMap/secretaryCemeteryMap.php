...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="secretaryCemeteryMap.css">
  </head>
  ...
  <body>
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="managementDropdown">
                            ...
                            <li><a class="dropdown-item active" href="../secretaryCemeteryMap/secretaryCemeteryMap.php">Cemetery Map Status</a></li>
    ...
    <script src="secretaryCemeteryMap.js" defer></script>
  </body>
</html>